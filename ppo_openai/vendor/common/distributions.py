...
class PdType(object):
    ...
    def pdclass(self):
        """
        Get the according Probability Distribution class,
        i.e. the `Pd` class.

        :return: the according `Pd` class
        """
        raise NotImplementedError

    def pdfromflat(self, flat):
        """
        Create a probability distribution from flat parameters
    ...
    def pdfromlatent(self, latent_vector, init_scale, init_bias):
        """
        Create a probability distribution from a latent vector
...
class CategoricalPdType(PdType):
    ...
    def pdfromlatent(self, latent_vector, init_scale=1.0, init_bias=0.0):
        pdparam = _matching_fc(latent_vector, init_scale=init_scale, init_bias=init_bias)
...
def _matching_fc(tensor, name, size, init_scale, init_bias):
    """
    This function is used to match the size of the input tensor to the size of the output tensor.
    ...
    :return:
    """
    # if the tensor size is [N,] or [1, N], etc.., then just return
